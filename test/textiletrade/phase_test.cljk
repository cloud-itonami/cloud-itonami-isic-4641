...
(deftest delivery-dispatch-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real textile/apparel/footwear goods dispatch"
...
(deftest invoice-settle-never-auto-at-any-phase
  (testing "structural invariant: no phase, now or in any future entry, auto-commits a real textile invoice settlement"
    (doseq [[n {:keys [auto]}] phase/phases]
