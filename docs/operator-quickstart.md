# Operator Quickstart — Wholesale of textiles, clothing and footwear

Shortest path from clone to a verified local dry-run for **ISIC 4641** (`cloud-itonami-isic-4641`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-4641.git
cd cloud-itonami-isic-4641
```
...
- Blueprint governor key: `textile-trading-governor`
- Likely source path: `textiletrade.governor.cljc`
